...
# === input files ===
bFile <- "/Users/lalithaviswanathan/Documents/Project/Cubi_LChesnel_EPAN12_0120/ref97_gg98_filtered_31345.txt" # FULL path to presence/absence table
aFile <- "/Users/lalithaviswanathan/Documents/Project/Cubi_LChesnel_EPAN12_0120/ref97_gg98_filtered_31345.txt" # FULL path to abundance table
...
mFactors <- c('Timepoint', 'Treatment','CB315vUNT','METvUNT','CUB2vUNT', 'VANvUNT','GENTvUNT','CB315vMET','CB315vCUB2','CB315vVAN','CB315time','METtime','CUB2time','VANtime');

# here define which factor(s) will be used for filtering.
mFilterFactors <- c('') # what is actually used in the anylsis only in DataRedn3 or 5 l 56 ff
...
normalize  <- F   # normalization flag, if set to TRUE, the normalization of all data reduction tables is performed.
...
doNMDS   <- FALSE # Non metric Multi-Dimensional Scaling
